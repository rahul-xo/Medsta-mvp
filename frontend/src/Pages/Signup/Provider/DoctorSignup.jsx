...
const DoctorSignup = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      // providers_doctors: detailed profile
      await setDoc(doc(db, 'providers_doctors', user.uid), {
    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-50 py-12">
      <div className="max-w-md w-full px-6">
        <div className="bg-white rounded-xl shadow-md p-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-1">Create a Doctor Account</h1>
          <p className="text-sm text-slate-500 mb-6">Join HealTech and start accepting appointments.</p>
