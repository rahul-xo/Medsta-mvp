...
const Home = () => {
  ...
  return (
    <div className="w-full pt-16"> {/* Add padding top to avoid navbar overlap */}
      
      {/* Welcome Section */}
      <section className="text-center py-8 md:py-10 px-4 bg-white">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        <h2 className="text-2xl font-semibold text-blue-800 mb-6">Our Partners Near You</h2>
